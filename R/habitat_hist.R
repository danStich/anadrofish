#' @title American shad historical habitat
#'
#' @description A dataset containing the surface area of American 
#' shad habitat segments by feature (dam or outlet) in
#' Atlantic coast drainages. Modified from \code{anadrofish::habitat} to
#' include historical dams that were removed before compilation of
#' contemporary geospatial databases.
#'
